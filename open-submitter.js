...
(function() {
  ...
  casper.doStep = function(objStep, serviceName) {
    ...
    if (objStep.command === 'click') {
      ...
      if (this.exists(tempObj)) {
        ...
        if (objStep.confirm) {
          this.waitForSelector(objStep.confirm, function() {
            return this.echo('Found confirm selector.');
          }, function() {
        ...
        if (objStep.confirmtxt) {
          this.waitForText(objStep.confirmtxt, function() {
            return this.echo('Found confirm text: ' + objStep.confirmtxt);
          }, function() {
            this.echo('Confirm text' + objStep.confirmtxt + 'not found', 'ERROR');
            errorMsg();
            return this.capture('./capture/error.png');
          });
        }
  ...
  casper.then(function() {
    return consolex.log('blue', 'Submitting links to indexeing services');
  });
